...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"alvarolop","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'alvarolop', repo 'etx-agentic-ai', "
